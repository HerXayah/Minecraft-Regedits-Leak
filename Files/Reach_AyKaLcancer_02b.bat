...
ECHO  
ECHO.
ECHO  Reach 0,2 blocks by AyKaLeGROSCANCER <3
ECHO  Tu dois éxécuter ce .bat en tant qu'Administrateur , sinon sa ne marchera pas.
ECHO  Met le .bat dès que tu allumes ton pc.
ECHO.
ECHO  
ECHO  Appui(e) sur "Y" pour que ta reach augmente de 0,2.
ECHO  
:LOOP
SET /P choice1= Tappe Y, et appuie sur ENTRER:   
...
CLS
ECHO  Appui(e) sur n'importe quel touche.
GOTO SUCCESS
...
ECHO.
ECHO  Ce .bat viens de t'améliorer ta reach de 0,2
ECHO.
@PAUSE
EXIT
...
:CANCEL
CLS 
ECHO   Appui(e) sur une touche pour QUITTER
ECHO.
ECHO   Dit MERCI au .bat et merci à Ayka <3
ECHO.
@PAUSE
EXIT
