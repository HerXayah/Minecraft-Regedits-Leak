@echo off
title IBLUECOMBO Private Regedit v2
color a

echo IBLUECOMBO Private Regedit v2 (25 euro)
timeout 3
cls
echo Leaking this program doesnt matter there will be a new one within a week!
timeout 3
cls
