@shift /0
@echo off
title Stability [Version 2.0]
cls
color d
cls
echo _______________________________________________________________________________
echo.
echo - Welcome to Stability V2! Stability is an all-in-one programme that provides -
echo - you with a smoother and faster Minecraft experience! The reason why this is -
echo - important is so that you can win your fights a lot easier. Remember, do NOT -
echo - leak Stability. It will only revoke YOUR access. Refunds shall not be given -
echo - to the people who leak it, or share it. Thank you for purchasing Stability! -
echo _______________________________________________________________________________
echo.
echo                        Press any key to start Stability!                            
pause >nul
:continue
cls
color d
...
echo _______________________________________________________________________________
echo.
echo - Thank you for purchasing Stability V2! Press any key to exit the programme. -
echo - Make sure to restart your PC, otherwise Stability's settings will NOT work! -
echo _______________________________________________________________________________
echo. 
echo                        Press any key to close Stability!                       
pause >nul
cls
exit
