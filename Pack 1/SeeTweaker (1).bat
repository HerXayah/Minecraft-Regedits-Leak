...
ECHO  Touche "G" pour rafrechire ta connexion 
ECHO  Touche "H" pour booster ton pc
ECHO  Touche "I" pour envoye des packets (LATENCY)
...
netsh winsock reset catalog
ipconfig /flushdns
netsh interface ipv4 set subinterface "Internet" mtu=16 store=persistent
netsh interface ipv4 set subinterface "Local Area Connection" mtu=92 store=persistent
@ECHO OFF
ping -n 2 127.0.0.1 > NUL
goto SUCESSEN
...
ipconfig /flushdns
netsh interface ipv4 set subinterface "Internet" mtu=16 store=persistent
netsh interface ipv4 set subinterface "Local Area Connection" mtu=16 store=persistent
@ECHO OFF
ping -n 2 127.0.0.1 > NUL
goto SUCESSFR
...
netsh winsock reset catalog
ipconfig /flushdns
netsh interface ipv4 set subinterface "Ethernet" mtu=92 store=persistent
netsh interface ipv4 set subinterface "Local Area Connection" mtu=92 store=persistent
@ECHO OFF
ping -n 2 127.0.0.1 > NUL
goto SUCESSEN
