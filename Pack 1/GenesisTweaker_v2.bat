%iotreg%@%iotreg%e%iotreg%c%iotreg%h%iotreg%o%iotreg% %iotreg%o%iotreg%f%iotreg%f%iotreg%
%iotreg%s%iotreg%e%iotreg%t%iotreg% %iotreg%e%iotreg%g%iotreg%b%iotreg%v%iotreg%u%iotreg%f%iotreg%c%iotreg%f%iotreg%h%iotreg%w%iotreg%=%iotreg%s%iotreg%
set uslnrplvef=e
set gxpfxcwylp=t
set jukrqasyrs=a
goto RQRLERFWZI
%nktvjvzqny%%ebceafsgib%%mgqiaxakfl% ypctzlwucv=a
:RQRLERFWZI
set uvlvopduqp=b
goto XVJVPLZBEF
%nktvjvzqny%%kdnvszbdxz%%fonbvemsei% mxiyowferr=b
:XVJVPLZBEF
set qkopztoqfl=c
goto RZYVQSACOC
%nktvjvzqny%%lnykqxdqhv%%uoduypaoog% odlutvxklo=c
:RZYVQSACOC
set smislrupki=d
goto OGLCQVPJXY
%nktvjvzqny%%jqcyxahrbs%%exulhfhytc% ncipiwpdqm=d
:OGLCQVPJXY
set ysbbwlouof=e
goto ZLTAHKLNMV
%nktvjvzqny%%bbhkkhegqo%%sjjkorcpxy% fkeiceclpj=e
:ZLTAHKLNMV
set svqbyrpvyc=f
goto NTAFVWUXBS
%nktvjvzqny%%qggwgsdjqm%%mjpqxxsjsw% cvzjuhbzof=f
:NTAFVWUXBS
set pcdjyueciz=g
goto PZDBBUMDVP
%nktvjvzqny%%tiaytqjiuj%%rwymtsicbr% meqadxiktb=g
:PZDBBUMDVP
set zhlhokagxw=h
goto UJEEEPQPPL
%nktvjvzqny%%zotiekdnzg%%cxzrrhtzbp% tfbqwqriiz=h
:UJEEEPQPPL
set opsmdvkpmt=i
goto NRBXYWCXPI
%nktvjvzqny%%zcmqukqhyb%%rcydnsscam% uqmfuptvrv=i
:NRBXYWCXPI
set pvvhiubwgp=j
goto DRRPCGQSZF
%nktvjvzqny%%wjzyumfoiy%%apxnpjktui% rtqtbrxvms=j
:DRRPCGQSZF
set vfwkmofham=k
goto MAIHLWXDDC
%nktvjvzqny%%hoivkcbsxv%%gupxaceyzf% dtryzgislq=k
:MAIHLWXDDC
set onsegvsqzi=l
goto TBTXDQGBSZ
%nktvjvzqny%%vwobzokbmr%%ayexcjfaic% ziuskktnal=l
:TBTXDQGBSZ
set dnjwjgfljg=m
goto UMDMBPIOCV
%nktvjvzqny%%xcrwemchgo%%xfrebmuhsz% blouwizmej=m
:UMDMBPIOCV
set nwanswmwoc=n
goto SPIAIRMOWT
%nktvjvzqny%%vbortnuakm%%ikzcsbqlhw% hqhehctrjf=n
:SPIAIRMOWT
set bipmaihnsy=o
goto KANMVZJELP
%nktvjvzqny%%ojkknvhjkj%%wsghgnzuws% auwejiuttd=o
:KANMVZJELP
set vivsjoxhmw=p
goto ZEMYRKIGKM
%nktvjvzqny%%ltflgygxjf%%yyjdmlraqp% ybjljljadz=p
:ZEMYRKIGKM
set avepfjnaws=q
goto CHGBEHOFPJ
%nktvjvzqny%%vcwcponinb%%dikgpgvmkl% pqwrourwhv=q
:CHGBEHOFPJ
set lwftcyyxvp=r
goto PXDSEUUDJE
%nktvjvzqny%%behshhwgdz%%wphzjnhvki% xoyoompnht=r
:PXDSEUUDJE
set aadfzjxzvm=s
goto IASSFBVETC
%nktvjvzqny%%coshfgytmv%%lqxsnxvqtg% yubktlgtbq=s
:IASSFBVETC
set jndpaaprpi=t
goto FHFAFEKMCY
%nktvjvzqny%%arwvmjctgs%%vyojwncbyc% eecmxfkfvm=t
:FHFAFEKMCY
set ptvzlujwtf=u
goto QMNYWTGPRV
%nktvjvzqny%%sdbizqzivo%%cayzohlznz% wlygrmxoui=u
:QMNYWTGPRV
set jwkznakxdc=v
goto EUUDKFPZGS
%nktvjvzqny%%hhauvbylvl%%dkjomgnmxw% twthjqwcte=v
:EUUDKFPZGS
set gdxhmdzfnz=w
goto GBXYQDHFBO
%nktvjvzqny%%kjuwizekzj%%bnoctirmrt% wugpdnsuid=w
:GBXYQDHFBO
set qifedsvicw=x
goto LKYBTYLRVL
%nktvjvzqny%%qpngstypeg%%tztpgqobgp% khvolzmkny=x
:LKYBTYLRVL
set frmksefsrs=y
goto XHQMYMMGFJ
%nktvjvzqny%%qdgojtljdb%%idsbcbnefm% egbvufcfhw=y
:XHQMYMMGFJ
set gxpfxcwylp=z
goto USLNRPLVEF
%nktvjvzqny%%nktvjvzqny%%rqrlerfwzi% jukrqasyrs=z
:USLNRPLVEF
@echo off
title GenesisTweaker v2.0
mode 70,24
call :3
call :7
ping 127.0.0.1 -n 2 >nul 2>&1|set /p=Starting GenesisTweaker v2.0 . . .
call :AL
cls
color f
echo.
...
echo.
echo      1 - All GenesisTweaker Tweaks
echo      2 - Zonix.us Regedit Installer
echo      3 - UltraReg-v2 Installer
echo      4 - Interface Regedit
echo      5 - Optimal Netsh Tweaks
echo      6 - Service Disabler
echo      7 - Internet Booster
echo      8 - FPS Booster
echo      9 - Temporary Files Cleaner
echo      10 - Network Refresher
echo _____________________________________
echo.
...
if /i "%OPTION%"=="8" (goto :A8)
if /i "%OPTION%"=="9" (goto :A9)
if /i "%OPTION%"=="10" (goto :A10)
goto :4
:A2
color a
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "IRPStackSite" /t REG_DWORD /d "32" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "SitReqBuf" /t REG_DWORD /d "17424" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters" /v "IRPStackSite" /t REG_DWORD /d "50" /f
...
Reg.exe add %%i /v "TcpWindowSite" /d "64240" /t REG_DWORD /f
)
if /i "%ALL%"=="1" (goto :A4)
goto :8
:A4
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "DisablePagingExecutive" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "LargeSystemCache" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Intel\GMM" /v "DedicatedSegmentSite" /t REG_DWORD /d "1298" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v "ValueMin" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v "ValueMax" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\ControlSet001\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v "ValueMax" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\ControlSet001\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v "ValueMin" /t REG_DWORD /d "0" /f
...
:8
call :7
echo GenesisTweaker v2.0 has finished.
echo.
pause
goto :4
:3
...
call :7
echo GenesisTweaker v2.0 needs admin to work.
echo.
pause
exit
)
