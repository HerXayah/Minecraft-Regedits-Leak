...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\FPS\Parameters" /v "MaximumFrames" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\Control Panel\Desktop\PerMonitorSettings" /f
Reg.exe add "HKCU\Control Panel\Desktop" /v "MenuShowDelay" /t REG_SZ /d "0" /f
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\" /v "System" /t REG_DWORD /d "0" /f
