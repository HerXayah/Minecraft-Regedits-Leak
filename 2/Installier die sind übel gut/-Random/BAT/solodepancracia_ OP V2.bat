...
color 03
echo --------------------------------------------------------------------------------------------------------------	
echo 				              thiago hipster style

echo				  	         SOLODEPANCRACIA_ 
...
echo #### [15] Type "15" For: KnockbackMachine ####
echo #### [16] Type "16" For: Solopancracia_reach##
echo $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
if /i "%asw%"=="15" goto:KnockbackMachine
if /i "%asw%"=="16" goto:Solopancracia_reach
echo.
goto:choice 
...
SET WAIT_TIME=2
@ping 127.0.0.1 -n %WAIT_TIME% -w 1000 > nul
START %BROWSER% -new-tab "https://pbs.twimg.com/profile_images/762398890746187776/D_Bip60K.jpg"
pause
goto:menu
